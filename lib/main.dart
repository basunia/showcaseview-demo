...
import 'package:tooltip_demo/showcaseview/src/showcase_widget.dart';
// import 'package:showcaseview/showcaseview.dart';

import 'detail_screen.dart';
import 'showcaseview/src/showcase.dart';
...
class _MailPageState extends State<MailPage> {
  ...
  // TODO: Give long text of your widget as descrition
  final String longText =
      'Search here Tap to find merchant info at begining of the page';
  List<Mail> mails = [];
  ...
  void initState() {
    ...
    (WidgetsBinding.instance).addPostFrameCallback(
      (_) => ShowCaseWidget.of(context).startShowCase([_six]),
    );
    mails = [
      Mail(
        sender: 'Medium',
